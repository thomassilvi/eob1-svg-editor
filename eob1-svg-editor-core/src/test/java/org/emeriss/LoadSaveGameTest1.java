...
public class LoadSaveGameTest1 extends TestCase
{
    private SaveGame s;
    private static final Logger LOGGER = Logger.getLogger(LoadSaveGameTest1.class);


    public LoadSaveGameTest1( String testName )
    {
        super( testName );
        s = new SaveGame();
    ...
    {
        return new TestSuite( LoadSaveGameTest1.class );
    }
    ...
    public void testCharacterZero()
    {
        ...
        assertEquals("Class",c.getCharacterClass(),CharacterClass.FIGHTER);
    ...
    public void testCharacterOne()
    {
        ...
        assertEquals("CHA",c.getCharisma(),12);
        assertEquals("Class",c.getCharacterClass(),CharacterClass.RANGER);
    ...
    public void testCharacterTwo()
    {
        ...
        assertEquals("Class",c.getCharacterClass(),CharacterClass.MAGE);
        assertEquals("Gender",c.getGender(),Gender.MALE);
    ...
    public void testCharacterThree()
    {
        ...
        assertEquals("CHA",c.getCharisma(),15);
        assertEquals("Class",c.getCharacterClass(),CharacterClass.CLERIC);
        assertEquals("Gender",c.getGender(),Gender.MALE);
